...
for i=1:M
    for j=1:R
        [t1(i,j),dt1(i,j)]=SocDynK_time(n(l),beta,[r_e*ones(1,n_e(i)) r_f*ones(1,n_n-n_e(i))],[k_e*ones(1,n_e(i)) k_f*ones(1,n_n-n_e(i))],n(l)-n_n);
...
for i=1:M
    for j=1:R
        [t2(i,j),dt2(i,j)]=SocDynK_time(n(l),beta,[r_e*ones(1,n_e(i)) r_f*ones(1,n_n-n_e(i))],[k_e*ones(1,n_e(i)) k_f*ones(1,n_n-n_e(i))],n(l)-n_n);
...
for i=1:M
    for j=1:R
        [t3(i,j),dt3(i,j)]=SocDynK_time(n(l),beta,[r_e*ones(1,n_e(i)) r_f*ones(1,n_n-n_e(i))],[k_e*ones(1,n_e(i)) k_f*ones(1,n_n-n_e(i))],n(l)-n_n);
...
for i=1:M
    for j=1:R
        [t4(i,j),dt4(i,j)]=SocDynK_time(n(l),beta,[r_e*ones(1,n_e(i)) r_f*ones(1,n_n-n_e(i))],[k_e*ones(1,n_e(i)) k_f*ones(1,n_n-n_e(i))],n(l)-n_n);
